...
de los modelos que se apliquen-.
'''
...
RM, AGE, DIS, y TAX son numèricas continuas de tipo real. En tanto las 
variables CHAS  y RAD son variables discretas/categoricas. 
Todas las variables y/o atributos cuentan con 506 registros y no 
presentan datos nulos ni erroneos-.
'''
...
mas robusto frente a OUTLIERS como el de Regresion Logistica aplica
mejor que uno de RL y/o RP) y/o, si el modelo de AA se considera dado 
(ej. RL y/o RP), a la hora de curar los datos para analizar y comparar
las metricas resultantes del modelo con y sin curacion de los 
OUTLIERS-.
'''
...
variable RAD, indice que indica el acceso a la carretera radial 
(circunvalacion bostoneana?), a 132 casos (26.09%) le corresponde
el mayor indice (24); seguidos por 115 y 110 casos, 22.73% y 21.74% 
respectivamente, a los indices 5 y 4 respectivamente. El resto de los
indices, 1, 2, 3, 6, 7 y 8 presentan la menor cantidad de indices
variando entre 17 y 38, indices 1 y 3 respectivamente.
...
target/MEDV-CRIM: a medida que aumenta la tasa de crimen/per capita por 
                  ciudad/suburbio- el el precio medio de la casa 
...
# 2-3- Para ud., ¿cuáles son esos atributos? Lístelos en orden
#      de importancia.-.
'''
...
# Adenda XX: para corroborar los resultados presentados a continuacion
...
fin de prevenir, ya que: (adapatado de     )-.
...
* Estandizarizacion del DS @ reducir los efectos de las diferentes distribuciones
  obsevadas en los atributos/variables del DS (ver comentario punto )
'''
...
# puntaje de regresion de la varianza explicada. best == 1.0, woese == 0-.
...
# 4-2- Grafiqaue las curvas de error en terminos del grado del
#      polinomio.
if True: # @ comentado 30052022
